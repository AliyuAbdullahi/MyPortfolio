...
object Constants {
    ...
    const val ANDROID_DESCRIPTION =
        "With my vast knowledge in android framework, over time I have gained proficiency in Java, Kotlin and C++, good UI/UX, scalable Architectural Patterns(MVP, MVVM, MVI), API Integrations, Database Management, Testing and Debugging, App Publishing."
    const val IOS_DESCRIPTION =
        "At FREE NOW, I contributed to the Business Profile development for the Business Customers on iPhone using SwiftUI and Story Board"
    const val WEB_DEVELOPMENT =
        "At Andela, I contributed to the company website infrastructure/architecture using tools like Angular.js, JQuery.js, Node.js, MongoDB, PostgreSQL, Redis DB, Bootstrap."
    const val BACKEND_SERVICE =
...
object Res {
    object Image {
        ...
        const val avatar6 = "avatar6.jpeg"
    }
